    ...
    less: {
        ...
        files: [
          {
            expand: true,
            cwd: '<%= config.lessDir %>',
            src: ['**/*.less', '!<%= config.sassMainFileName %>.less'],
            dest: '<%= config.cssDir %>',
            ext: '.css'
          },
          {src: '<%= config.lessDir %><%= config.sassMainFileName %>.less', dest: '<%= config.cssMainFileDir %><%= config.cssMainFileName %>.css'}
        ]
      },
      dist: {
        options: {
      ...
      min: {
        ...
        files: [
          ...
          {src: '<%= config.lessDir %><%= config.sassMainFileName %>.less', dest: '<%= config.cssMainFileDir %><%= config.cssMainFileName %>.min.css'}
        ]
      }
    },
...
//finally 
  //css beautiful
  grunt.registerTask('cssbeauty', ['less:dist', 'cmq:dist', 'postcss:dist', 'csscomb:dist']);
  //img minify
